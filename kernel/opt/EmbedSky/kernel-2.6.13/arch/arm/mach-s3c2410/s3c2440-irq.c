...
//			mydesc->handle( IRQ_S3C2440_WDT, mydesc, regs);					//HJ_del
			mydesc->handle( IRQ_S3C2440_CAM_C, mydesc, regs);				//HJ_add
		}
		if (subsrc & 2) {
			mydesc = irq_desc + IRQ_S3C2440_CAM_P;
//			mydesc->handle(IRQ_S3C2440_AC97, mydesc, regs);					//HJ_del
			mydesc->handle(IRQ_S3C2440_CAM_P, mydesc, regs);				//HJ_add
		}
	}
}
