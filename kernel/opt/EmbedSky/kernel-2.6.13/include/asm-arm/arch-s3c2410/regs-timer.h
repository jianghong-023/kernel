...
#define S3C2440_TCNTB0	      S3C2410_TIMERREG(0x0C)
#define S3C2440_TCMPB0	      S3C2410_TIMERREG(0x10)
#define S3C2440_TCNTO0	      S3C2410_TIMERREG(0x14)
#define S3C2440_TCNTB1	      S3C2410_TIMERREG(0x18)
#define S3C2440_TCMPB1	      S3C2410_TIMERREG(0x1C)
#define S3C2440_TCNTO1	      S3C2410_TIMERREG(0x20)
#define S3C2440_TCNTB2	      S3C2410_TIMERREG(0x24)
#define S3C2440_TCMPB2	      S3C2410_TIMERREG(0x28)
#define S3C2440_TCNTO2	      S3C2410_TIMERREG(0x2C)
#define S3C2440_TCNTB3	      S3C2410_TIMERREG(0x30)
#define S3C2440_TCMPB3	      S3C2410_TIMERREG(0x34)
#define S3C2440_TCNTO3	      S3C2410_TIMERREG(0x38)
#define S3C2440_TCNTB4	      S3C2410_TIMERREG(0x3C)
#define S3C2440_TCNTO4	      S3C2410_TIMERREG(0x40)
