...
// ghcstop add: ÀÓ½Ã ¶«»§ÄÚµå
#define GPCON(x)		(*(volatile unsigned *)(S3C2410_VA_GPIO+(x)*0x10))
#define GPDAT(x)		(*(volatile unsigned *)(S3C2410_VA_GPIO+(x)*0x10+0x04))
#define GPUP(x)			(*(volatile unsigned *)(S3C2410_VA_GPIO+(x)*0x10+0x08))
