...
//static int debug	= 0;						//HJ_del
static int debug	= 1;						//HJ_add

module_param(tmr_margin, int, 0);
//module_param(tmr_atboot, int, 0);					//HJ_del
module_param(tmr_atboot, int, 1);					//HJ_add
module_param(nowayout, int, 0);
module_param(soft_noboot, int, 0);
//module_param(debug, int, 0);					//HJ_del
module_param(debug, int, 1);					//HJ_add
