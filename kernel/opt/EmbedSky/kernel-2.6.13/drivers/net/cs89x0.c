...
#include <asm/dma.h>
#endif
#ifdef CONFIG_ARCH_TQ2440	// HJ add
...
#elif defined(CONFIG_ARCH_TQ2440)	// HJ add
static unsigned int netcard_portlist[] __initdata = {TQ_VA_CS8900A + DEFAULTIOBASE, 0};
...
#ifdef CONFIG_ARCH_TQ2440	// initialize CS8900, HJ add

	//__raw_writel((__raw_readl(S3C2410_BWSCON)&~(0xf<<12))|(0xd<<12),S3C2410_BWSCON);
	//__raw_readl(S3C2410_GPACON);
	__raw_writel((__raw_readl(S3C2410_GPGCON)&~(0x3<<2))|(0x2<<2),S3C2410_GPGCON);
	//__raw_writel(S3C2410_BANKCON_PMCnorm|S3C2410_BANKCON_Tacp6|S3C2410_BANKCON_Tcah4|S3C2410_BANKCON_Tcoh1|
//			S3C2410_BANKCON_Tacc14|S3C2410_BANKCON_Tcos4|S3C2410_BANKCON_Tacs0,S3C2410_BANKCON3);
...
#endif
	{
#if !defined(CONFIG_ARCH_IXDP2X01) && !defined(CONFIG_ARCH_TQ2440)	// jdh modified
...
#ifndef CONFIG_ARCH_TQ2440	// HJ add
                        printk(KERN_WARNING "%s: 10Base-T (RJ-45) has no cable\n", dev->name);
#endif
                        if (lp->auto_neg_cnf & IMM_BIT) /* check "ignore missing media" bit */
#ifdef CONFIG_ARCH_TQ2440	// HJ add
                                result = DETECTED_RJ45F; /* Yes! I don't care if I see a link pulse */
#else
