...
//#define NS_IN_KHZ 1000000		//HJ_del
#define NS_IN_KHZ 10000000		//HJ_add

static int s3c2410_nand_calc_rate(int wanted, unsigned long clk, int max)
{
	int result;

//	result = (wanted * NS_IN_KHZ) / clk;		//HJ_del
	result = (wanted * (clk / 1000)) / 1000000;		//HJ_add
	result++;
...
//	printk(KERN_INFO PFX "timing: Tacls %dns, Twrph0 %dns, Twrph1 %dns\n",
